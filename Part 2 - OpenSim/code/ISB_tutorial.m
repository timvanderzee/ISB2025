...
names = {'hamstrings_r'; 'bifemsh_r'; 'glut_max_r'; 'iliopsoas_r'; 'rect_fem_r'; 'vasti_r'; 'gastroc_r'; 'soleus_r'; 'tib_ant_r'};
...
osimModel = Model('SCP_gait4dof9musc.osim'); %

% 3D model: only used to get muscle info
osimModel3D = Model('SCP_gait10dof18musc.osim'); %
