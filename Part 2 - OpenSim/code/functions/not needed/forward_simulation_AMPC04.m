...
IKpath = ['C:\Users\u0046458\Documents\Unief\code\GT\AMPC04\ModelsForForwardSimulation\SCP_gait10dof18musc_Trial' num2str(trial) '.mot'];
...
load C:\Users\u0046458\Documents\Unief\code\GT\AMPC04\PlatOnsets.dat
load_simulation_parameters
...
load(['C:\Users\u0046458\Documents\Unief\code\GT\AMPC04\ExperimentalData\trial' num2str(trial)], 'data');
...
osimModel = Model('C:\Users\u0046458\Documents\Unief\code\GT\AMPC04\ModelsForForwardSimulation\AMPC04_gait4dof9musc.osim'); %
osimModel3D = Model('C:\Users\u0046458\Documents\Unief\code\GT\AMPC04\ModelsForForwardSimulation\AMPC04_gait10dof18musc.osim'); % 
nom = length(namen);
params = zeros(5, nom);
...
for k = 1:length(vec_ksrs)
    ...
    if k == 1
        load(['musdyn_SRS_dlmt_Trial' num2str(trial) '_ebase5_0_50ms_ksrs' num2str(vec_ksrs(k)) '_web0'], 'solution')
