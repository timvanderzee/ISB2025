function [error_f1] = OdeFun_F1_no_SRS(t,y,yp, params)
...
[error_all] = CalculateMusculoSkeletalDynamics_F1_no_SRS(y(1),y(2),yp(2), y(3:4), lM_projected,params.kFpe,vMtilda, ...
    params.a_ext, params.a_flex, params.data_exp, params.coeff_LMT_ma, params.params_OS, params.shift, params.B, params.info, params.I_opt); 

error_vel = y(2) - yp(1);
error_f1 = [error_vel; error_all(5); error_all(1:2)];
