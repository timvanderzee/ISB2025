function [error] = CalculateBioMusculoSkeletalDynamics_F2_ForceFeedback(q,qd,qdd,lMtilda, lM_projected, kFpe, vMtilda, a_ext, a_flex, data_exp, coeff_LMT_ma, params_OS, shift, B, info, Fsrs, dFsrsdt, Fsrs_del, dFsrs_deldt, kR,Fce_del, dFce_deldt, I_opt, Q0, Q2, dQ0dt, dQ2dt)
